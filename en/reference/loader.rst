...
:doc:`ManaPHP\\Loader` is a component that allows you to load project classes automatically,
...
:doc:`ManaPHP\\Loader` serves as the special handler for this operation.
...
:doc:`ManaPHP\\Loader` offers four options to autoload classes. You can use them one at a time or combine them.
...
Security Layer
--------------
:doc:`ManaPHP\\Loader` offers a security layer sanitizing by default class names avoiding possible inclusion of unauthorized files.
...
To avoid these or most sophisticated attacks, :doc:`ManaPHP\\Loader` removes any invalid character from the class name
