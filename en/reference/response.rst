...
Part of the HTTP cycle is returning responses to clients. :doc:`ManaPHP\\Http\\Response` is the ManaPHP
...
A :doc:`ManaPHP\\Http\\Response\\Headers` bag internally manages headers. This class
...
Making Redirections
-------------------
With :doc:`ManaPHP\\Http\\Response` you can also execute HTTP redirection:
